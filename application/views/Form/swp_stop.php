                    ...
                    <form action="" id="<?php echo $data . 'Form' ?>">
                        ...
                        <div class="row">
                            ...
                            <div class="col-md-3 col-sm-12">
                                ...
                                <input class="form-control form-control-sm mt-1" type="date" name="swp_stop_date" id="swp_stop_date" required>
                            </div>
                            <div class="col-md-3 col-sm-12">
                            ...
                            <div class="col-md-3 col-sm-12 mt-3">
                                ...
                                <input class="form-control form-control-sm mt-1" type="text" name="swp_stop_client_name" id="swp_stop_client_name" required>
                            </div>
                            <div class="col-md-3 col-sm-12 mt-3">
                                <label for="swp_stop_submit">Submit Place</label>
                                <input class="form-control form-control-sm mt-1" type="text" name="swp_stop_submit" id="swp_stop_submit" required>
                            </div>
                            <div class="col-md-3 col-sm-12 mt-3">
                                <label for="swp_stop_scheme">Scheme Name</label>
                                <input class="form-control form-control-sm mt-1" type="text" name="swp_stop_scheme" id="swp_stop_scheme" required>
                            </div>
                            <div class="col-md-3 col-sm-12 mt-3">
                                <label for="swp_stop_amount">Amount</label>
                                <input class="form-control form-control-sm mt-1" type="text" name="swp_stop_amount" id="swp_stop_amount" required>
                            </div>
                            <div class="col-md-3 col-sm-12 mt-3">
                                <label for="swp_stop_folio_no">Folio No.</label>
                                <input class="form-control form-control-sm mt-1" type="text" name="swp_stop_folio_no" id="swp_stop_folio_no" required>
                            </div>
                            <div class="col-md-3 col-sm-12 mt-3">
