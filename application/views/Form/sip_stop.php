                    ...
                    <form action="" id="<?php echo $data . 'Form' ?>">
                        ...
                        <div class="row">
                            ...
                            <div class="col-md-3 col-sm-12">
                                ...
                                <input class="form-control form-control-sm mt-1" type="date" name="sip_stop_date" id="sip_stop_date" required>
                            </div>
                            <div class="col-md-3 col-sm-12">
                            ...
                            <div class="col-md-3 col-sm-12 mt-3">
                                ...
                                <input class="form-control form-control-sm mt-1" type="text" name="sip_stop_client_name" id="sip_stop_client_name" required>
                            </div>
                            ...
                            <div class="col-md-3 col-sm-12 mt-3">
                                ...
                                <input class="form-control form-control-sm mt-1" type="text" name="sip_stop_fund" id="sip_stop_fund" required>
                            </div>
                            <div class="col-md-3 col-sm-12 mt-3">
                                <label for="sip_stop_scheme">Scheme Name</label>
                                <input class="form-control form-control-sm mt-1" type="text" name="sip_stop_scheme" id="sip_stop_scheme" required>
                            </div>
                            <div class="col-md-3 col-sm-12 mt-3">
                            ...
                            <div class="col-md-3 col-sm-12 mt-3">
                                ...
                                <input class="form-control form-control-sm mt-1" type="text" name="sip_stop_folio_no" id="sip_stop_folio_no" required>
                            </div>
                            <div class="col-md-3 col-sm-12 mt-3">
                                <label for="sip_stop_amount">Amount</label>
                                <input class="form-control form-control-sm mt-1" type="text" name="sip_stop_amount" id="sip_stop_amount" required>
                            </div>
                            <div class="col-md-3 col-sm-12 mt-3">
