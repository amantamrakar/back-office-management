                    ...
                    <form action="" id="<?php echo $data.'Form' ?>">
                        ...
                        <input class="form-control form-control-sm mt-1" type="text" name="YmFzZTY0IGRlY29kZXI=" value="<?php echo base64_encode($data) ?>" id="" hidden>
                            <div class="col-md-3 col-sm-12">
                                ...
                                <input class="form-control form-control-sm mt-1" type="date" name="switch_date" id="switch_date">
                            </div>
                            <div class="col-md-3 col-sm-12">
                            ...
                            <div class="col-md-3 col-sm-12 mt-3">
                                ...
                                <input class="form-control form-control-sm mt-1" type="text" name="switch_client_name" id="switch_client_name">
                            </div>
                            <div class="col-md-3 col-sm-12 mt-3">
                            ...
                            <div class="col-md-3 col-sm-12 mt-3">
                                ...
                                <input class="form-control form-control-sm mt-1" type="text" name="switch_amc_name" id="switch_amc_name">
                            </div>
                            <div class="col-md-3 col-sm-12 mt-3">
                            ...
                            <div class="col-md-3 col-sm-12 mt-3">
                                ...
                                <input class="form-control form-control-sm mt-1" type="text" name="switch_scheme" id="switch_scheme">
                            </div>
                            <div class="col-md-3 col-sm-12 mt-3">
                                <label for="switch_submit">Submit Place</label>
                                <input class="form-control form-control-sm mt-1" type="text" name="switch_submit" id="switch_submit">
                            </div>
                            <div class="col-md-3 col-sm-12 mt-3">
                                <label for="switch_to_scheme">To Scheme Name</label>
                                <input class="form-control form-control-sm mt-1" type="text" name="switch_to_scheme" id="switch_to_scheme">
                            </div>

                            <div class="col-md-3 col-sm-12 mt-3">
                                <label for="switch_folio_no">Folio No.</label>
                                <input class="form-control form-control-sm mt-1" type="text" name="switch_folio_no" id="switch_folio_no">
                            </div>
                            <div class="col-md-3 col-sm-12 mt-3">
                                <label for="switch_amount">Amount</label>
                                <input class="form-control form-control-sm mt-1" type="text" name="switch_amount" id="switch_amount">
                            </div>
